...
\section{Probability} \label{sec:prob-spac-expect}

\subsection{Prelude}

This section sets up basic tools for working with probabilities. The main concepts are:
\begin{itemize}
\end{itemize}
...
This section defines basic concepts of probability spaces and random variables and proves some of their basic properties. 
